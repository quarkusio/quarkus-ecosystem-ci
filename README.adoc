...
An example project containing the proper Github Action YAML file (and which has been tested with the whole process) can be found https://github.com/geoand/quarkus-qpid-jms/blob/576cf704c95012c5309504765e775234143c6dd6/.github/workflows/quarkus-snapshots.yml[here].
