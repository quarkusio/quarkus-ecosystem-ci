...
An example project containing the proper Github Action YAML file (and which has been tested with the whole process) can be found https://github.com/geoand/quarkus-qpid-jms/blob/3dc093456dd46eb66b04e593860b0918ca0cad0a/.github/workflows/quarkus-master.yml[here].
