...
The following *additional* steps are only needed if your project is *NOT* a Quarkiverse participant (i.e. not a project of the https://github.com/quarkiverse[Quarkiverse] organization), as Quarkiverse projects are already set up this way:

1. ECOSYSTEM_CI_TOKEN Secret
+
